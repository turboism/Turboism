...
- [SDK API 契約と互換性](sdk/api-contracts/)、[SDK v9 移行ガイド](sdk/api-contracts/sdk-api-v9-review.md)、[SDK v8](sdk/api-contracts/sdk-api-v8-review.md)・[SDK v7](sdk/api-contracts/sdk-api-v7-review.md) レビューは履歴監査として保持
