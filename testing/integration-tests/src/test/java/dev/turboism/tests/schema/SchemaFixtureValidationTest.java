...
class SchemaFixtureValidationTest {
    ...
    @CsvSource({
        ...
        "duplicate-tags.json, plugin-meta-v3, plugin-meta-v3, PLUGIN_META_BAD_TAGS",
        "tag-overflow.json, plugin-meta-v3, plugin-meta-v3, PLUGIN_META_BAD_TAGS",
        "wrong-type-category.json, plugin-meta-v3, plugin-meta-v3, PLUGIN_META_BAD_CATEGORY",
        "non-array-tags.json, plugin-meta-v3, plugin-meta-v3, PLUGIN_META_BAD_TAGS",
