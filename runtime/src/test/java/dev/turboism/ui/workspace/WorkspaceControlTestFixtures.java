...
public final class WorkspaceControlTestFixtures {
    ...
    public static List<StaticSelector> selectors() {
        return List.of(
            ...
            StaticSelector.method("workspace.dock.palette-manager", name(Dock.class), "paletteManager", "()L" + name(PaletteManager.class) + ";", 1),
            StaticSelector.method("workspace.palette-manager.current", name(PaletteManager.class), "current", "()L" + name(Workspace.class) + ";", 1),
            ...
            StaticSelector.method("workspace.workspace.default-layout", name(Workspace.class), "defaultLayout", "()[B", 1),
    ...
    public static final class Dock {
        ...
        public PaletteManager paletteManager() { return new PaletteManager(this); }
    ...
    public record PaletteManager(Dock dock) { public Workspace current() { return dock.current; } }
    public record Workspace(Id id, String name) { public byte[] defaultLayout() { return null; } }
