 ...
 * See {@code compatibility/cubism/verification/cubism-5.2.03-ui-control-appearance.json} (mappingId
 * {@code cubism.mapping.5_2.ui_control_appearance.method.node_source}) and
 * {@code compatibility/cubism/verification/cubism-5.3.02-ui-control-appearance.json} (mappingId
