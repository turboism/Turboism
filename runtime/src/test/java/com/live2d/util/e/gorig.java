...
/**
 * Fixture replica of com.live2d.util.e.g — the 5.2.03 reference pipeline
 * (page-size scratch), calling the fixture jp.noids helpers. Used as the
 * unpatched reference: the patched g must be pixel-identical to this original.
 */
