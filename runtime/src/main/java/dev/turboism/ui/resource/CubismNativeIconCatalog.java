...
final class CubismNativeIconCatalog {
    ...
    // All sixty PNG hashes and dimensions were independently compared in both pinned JARs.
    ...
    private static Map<NativeIconVariant, String> parsePins() {
        ...
        if (result.size() != 60) throw new IllegalStateException("incomplete native icon catalog");
