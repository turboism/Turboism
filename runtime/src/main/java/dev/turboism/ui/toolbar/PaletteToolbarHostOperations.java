...
public interface PaletteToolbarHostOperations {
    ...
    /** Replaces the complete LOG contribution snapshot and reconciles it immediately. */
    void setContributions(List<ButtonContribution> contributions);

    /** Runs one lifecycle reconciliation immediately. */
    void reconcileNow();

    /** Clears all contributions, stops lifecycle polling, and restores host structure. */
