...
public final class EditorParameterStructureSelectorContract {
    ...
    /** Narrow exact-host candidate contract for creating one root Parameter. */
    public static final Set<String> PARAMETER_CREATE_REQUIRED_ALIASES = Set.of(
    ...
    /** Narrow exact-host candidate contract for creating one empty root Parameter folder. */
    public static final Set<String> FOLDER_CREATE_REQUIRED_ALIASES = Set.of(
        "cubism.editor-model.app-controller.instance",
        "cubism.editor-model.app-controller.current-document",
        "cubism.editor-model.app-controller.complete-pack",
        "cubism.editor-model.modeling-document.model-source",
