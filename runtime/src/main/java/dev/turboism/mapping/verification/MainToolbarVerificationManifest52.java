...
/** Runtime trust root for the exact Cubism 5.2 native main-toolbar binding. */
final class MainToolbarVerificationManifest52 {
    ...
    private MainToolbarVerificationManifest52() {
    }
}
