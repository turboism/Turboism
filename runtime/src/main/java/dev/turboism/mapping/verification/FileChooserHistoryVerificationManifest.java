...
/** Task-scoped runtime admission for exact-host 5.3.03 file-chooser history validation. */
public final class FileChooserHistoryVerificationManifest {

    public static final String CUBISM_VERSION_5_3_03 = "5.3.03";

    private static final String VALIDATION_PROPERTY =
        "turboism.validation.fileChooserHistory";
    ...
    private static final String VALIDATION_MODE_PROPERTY =
        "turboism.fileChooserHistoryValidation.mode";
    private static final String VALIDATION_MODE = "file-chooser-history-hook-5303";
    private static final String VALIDATION_RUN_ID_PROPERTY =
        "turboism.validation.runId";

    /** Returns whether this JVM is the exact task-scoped 5.3.03 file-chooser lane. */
    ...
    private FileChooserHistoryVerificationManifest() { }
}
