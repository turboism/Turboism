...
public final class EditorObjectHierarchyEditSelectorContract {
    ...
    private static final Set<String> CREATE_ALIASES = Set.of(
        ...
        "cubism.editor-model.part-source-set.class",
        "cubism.editor-model.part-source-set.add",
        "cubism.editor-model.deformer-source-set.class",
        "cubism.editor-model.deformer-source-set.add",
        "cubism.editor-model.part-source.create",
        "cubism.editor-model.warp-deformer-source.create",
        "cubism.editor-model.rotation-deformer-source.create",
