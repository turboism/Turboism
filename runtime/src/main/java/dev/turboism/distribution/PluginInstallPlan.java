...
public final class PluginInstallPlan {
    ...
    PluginInstallPlan(PackageIdentity identity, PluginDescriptor descriptor,
        ...
        if (this.files.size() != 1) throw new IllegalArgumentException("one plugin file required");
