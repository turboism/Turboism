...
final class EditorObjectReadAccess {
    ...
    private final class EditorDrawable extends ObjectView implements Drawable, EditorNativeObjectRef {
        ...
        @Override public void setOpacity(final float opacity) { final ObjectRef value = current(); EditorObjectReadAccess.this.setOpacity(Kind.ART_MESH, modelSource, value.source(), core.artMeshForm(value.instance()), "cubism.editor-model.drawable-form.opacity", "cubism.editor-model.drawable-form.set-opacity", opacity, "Set ArtMesh opacity"); }
        ...
        @Override public void setDrawOrder(final int drawOrder) { final ObjectRef value = current(); EditorObjectReadAccess.this.setDrawOrder(modelSource, value.source(), core.artMeshForm(value.instance()), drawOrder); }
        @Override public void setMultiplyColor(final Color color) { final ObjectRef value = current(); EditorObjectReadAccess.this.setColor(modelSource, value.source(), core.artMeshForm(value.instance()), "cubism.editor-model.drawable-form.multiply-color", color, "Set ArtMesh multiply color"); }
        @Override public void setScreenColor(final Color color) { final ObjectRef value = current(); EditorObjectReadAccess.this.setColor(modelSource, value.source(), core.artMeshForm(value.instance()), "cubism.editor-model.drawable-form.screen-color", color, "Set ArtMesh screen color"); }
    ...
    private abstract class DeformerView implements Deformer, EditorNativeObjectRef {
        ...
        @Override public void setOpacity(final float opacity) { final DeformerRef value = current(); EditorObjectReadAccess.this.setOpacity(value.kind(), modelSource, value.source(), core.deformerForm(value.instance()), "cubism.editor-model.deformer-form.opacity", "cubism.editor-model.deformer-form.set-opacity", opacity, "Set Deformer opacity"); }
