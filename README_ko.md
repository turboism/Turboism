...
- [SDK API 계약 및 호환성](sdk/api-contracts/), [SDK v8 마이그레이션 안내](sdk/api-contracts/sdk-api-v8-review.md), [SDK v7 리뷰](sdk/api-contracts/sdk-api-v7-review.md)는 이력 감사로 유지
