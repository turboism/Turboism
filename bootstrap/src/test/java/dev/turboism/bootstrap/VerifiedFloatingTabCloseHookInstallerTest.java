...
class VerifiedFloatingTabCloseHookInstallerTest {
    ...
    void installsOneExactTransformerAndRetransformsAnAlreadyLoadedTarget() {
        ...
        try (VerifiedFloatingTabCloseHookInstaller installer = new VerifiedFloatingTabCloseHookInstaller(
            instrumentation,
            methodSelector("operation", Target.class.getName().replace('.', '/'), "a", "(Ljava/lang/Object;)V"),
            fieldSelector("palette", Target.class.getName().replace('.', '/'), "b", "Ljava/lang/Object;"),
    ...
    @Test
    void rejectsSelectorsThatDoNotShareAnOwnerOrAllowStatic() {
        final Instrumentation instrumentation = (Instrumentation) Proxy.newProxyInstance(
            getClass().getClassLoader(),
            new Class<?>[]{Instrumentation.class},
        ...
        assertThrows(
            ...
            () -> new VerifiedFloatingTabCloseHookInstaller(
                instrumentation,
                methodSelector("operation", "fixture/A", "a", "(Ljava/lang/Object;)V"),
                fieldSelector("palette", "fixture/B", "b", "Ljava/lang/Object;"),
                Target.class.getClassLoader()
            )
        );
        assertThrows(
            ...
            () -> new VerifiedFloatingTabCloseHookInstaller(
                ...
                fieldSelector("palette", "fixture/A", "b", "Ljava/lang/Object;"),
                Target.class.getClassLoader()
            )
        );
    }
    ...
    private static StaticSelector methodSelector(
        ...
        return StaticSelector.method(
            alias, owner, name, descriptor, StaticSelector.ACCESS_PUBLIC | 0x10
        );
    }
