...
class ObjectContextMenuHostProfileTest {
    ...
    void pinsIndependent52And53OwnersAndAppendCardinality() {
        ...
        assertProfile(v52, "com/live2d/cubism/view/palette/parts/R", 21, 23);
        assertProfile(v53, "com/live2d/cubism/view/palette/parts/T", 22, 22);
    }
    ...
    private static void assertProfile(
        ...
        assertEquals(1, bindings.get(1).expectedAppendPoints());
        ...
        assertTrue(bindings.stream().allMatch(binding -> binding.injectionPoint() == 1));
    }
}
