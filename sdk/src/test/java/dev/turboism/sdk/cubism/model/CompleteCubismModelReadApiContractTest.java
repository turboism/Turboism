...
class CompleteCubismModelReadApiContractTest {
    ...
    void modelAndChildrenExposeTheCompleteSupportedReadShapeWithoutRawHostTypes() throws Exception {
        assertMethods(CubismModel.class,
            "canvas", "defaultKeyformLocked", "deformers", "drawables", "glues", "id", "mocInfo", "name", "parameterBindingBatch", "parameterBindings", "parameterDefinitions", "parameterGroups", "parameters", "parts", "rotationDeformers", "setDefaultKeyformLocked", "setName", "statistics", "update", "warpDeformers");
