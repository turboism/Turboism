...
public final class TopMenuVerificationManifest {
    ...
    public static final String CUBISM_VERSION_5_2_03 = "${record:cubism-5.2.03-ui-top-menu.json:cubismVersion}";

    /** Cubism version reported for the reviewed 5.3.02 artifact. */
    public static final String CUBISM_VERSION_5_3_02 = "${record:cubism-5.3.02-ui-top-menu.json:cubismVersion}";

    /** Cubism version reported for the reviewed 5.3.03 artifact. */
    public static final String CUBISM_VERSION_5_3_03 = "${record:cubism-5.3.03-ui-top-menu.json:cubismVersion}";
    ...
    public static final ReviewedSliceRecord RECORD_5_2_03 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.2.03-ui-top-menu.json:verificationId}",
        "${record:cubism-5.2.03-ui-top-menu.json:sha256}",
        CUBISM_VERSION_5_2_03,
        "${record:cubism-5.2.03-ui-top-menu.json:profileId}"
    );
    ...
    public static final ReviewedSliceRecord RECORD_5_3_02 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.3.02-ui-top-menu.json:verificationId}",
        "${record:cubism-5.3.02-ui-top-menu.json:sha256}",
        CUBISM_VERSION_5_3_02,
        "${record:cubism-5.3.02-ui-top-menu.json:profileId}"
    );
    ...
    public static final ReviewedSliceRecord RECORD_5_3_03 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.3.03-ui-top-menu.json:verificationId}",
        "${record:cubism-5.3.03-ui-top-menu.json:sha256}",
        CUBISM_VERSION_5_3_03,
        "${record:cubism-5.3.03-ui-top-menu.json:profileId}"
    );
    ...
    public static final String ADAPTER_SLICE_ID = "${record:cubism-5.2.03-ui-top-menu.json:adapterSliceId}";
