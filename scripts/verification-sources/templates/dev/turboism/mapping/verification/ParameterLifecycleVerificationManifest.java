...
/** Task-scoped runtime admission for exact-host 5.3.03 parameter lifecycle validation. */
public final class ParameterLifecycleVerificationManifest {
    ...
    private static final String VALIDATION_MODE_PROPERTY =
        "turboism.editorObjectValidation.mode";
    private static final String VALIDATION_MODE = "parameter-lifecycle-hook-5303";
    private static final String VALIDATION_RUN_ID_PROPERTY =
        "turboism.validation.runId";

    /** Returns whether this JVM is the exact task-scoped 5.3.03 parameter lifecycle lane. */
    ...
    private ParameterLifecycleVerificationManifest() {
    }
}
