...
public final class EditorModelVerificationManifest {
    ...
    public static final String CUBISM_VERSION_5_2_03 = "${record:cubism-5.2.03-editor-model.json:cubismVersion}";

    /** Cubism version reported for the reviewed 5.3.02 artifact. */
    public static final String CUBISM_VERSION_5_3_02 = "${record:cubism-5.3.02-editor-model.json:cubismVersion}";

    /** Cubism version reported for the reviewed 5.3.03 Editor records. */
    public static final String CUBISM_VERSION_5_3_03 = "${record:cubism-5.3.03-editor-model.json:cubismVersion}";
    ...
    public static final ReviewedSliceRecord RECORD_5_2_03 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.2.03-editor-model.json:verificationId}",
        "${record:cubism-5.2.03-editor-model.json:sha256}",
        CUBISM_VERSION_5_2_03,
        "${record:cubism-5.2.03-editor-model.json:profileId}"
    );
    ...
    public static final ReviewedSliceRecord RECORD_5_3_02 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.3.02-editor-model.json:verificationId}",
        "${record:cubism-5.3.02-editor-model.json:sha256}",
        CUBISM_VERSION_5_3_02,
        "${record:cubism-5.3.02-editor-model.json:profileId}"
    );
    ...
    public static final ReviewedSliceRecord RECORD_5_3_03 = new ReviewedSliceRecord(
        ...
        "${record:cubism-5.3.03-editor-model.json:verificationId}",
        "${record:cubism-5.3.03-editor-model.json:sha256}",
        CUBISM_VERSION_5_3_03,
        "${record:cubism-5.3.03-editor-model.json:profileId}"
    );
