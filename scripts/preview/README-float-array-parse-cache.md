...
The fixed-slot pair (`heavy-off-slots-r2-20260905T110135Z-2196008` / `heavy-on-slots-r2-20260905T110345Z-2201316`, under `float-array-parse-cache-5302-`) measured 108.130 / 109.036 seconds, 180.950 / 185.590 process CPU seconds, and 14.8477 / 14.3321 GB observed thread allocation. About 0.52 GB less observed allocation is not sufficient evidence of a useful load/CPU improvement. Keep this candidate off; the separately validated texture-upload preparation is the recommended allocation optimization.
