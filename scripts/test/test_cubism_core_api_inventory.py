...
def test_core_model_read_mapping_packs(
    ...
    expected = {
        ...
        "cubism.core.live2d.get-latest-moc-version": {
            "kind": "method",
            "owner": "com/live2d/sdk/cubism/core/Live2DCubismCore",
            "runtime": "getLatestMocVersion",
            "descriptor": "()I",
            "required": 9,
            "forbidden": 0,
            "access": {"public", "static"},
        },
        "cubism.core.live2d.get-moc-version": {
            "kind": "method",
            "owner": "com/live2d/sdk/cubism/core/Live2DCubismCore",
            "runtime": "getMocVersion",
            "descriptor": "([B)I",
            "required": 9,
            "forbidden": 0,
            "access": {"public", "static"},
        },
        "cubism.core.live2d.has-moc-consistency": {
            "kind": "method",
            "owner": "com/live2d/sdk/cubism/core/Live2DCubismCore",
            "runtime": "hasMocConsistency",
            "descriptor": "([B)Z",
            "required": 9,
            "forbidden": 0,
            "access": {"public", "static"},
