...
- **Cubism:** Requires Cubism. Admissions are recorded per exact reviewed Editor version (`5.2.03`, `5.3.03` at this time); unsupported or unreviewed hosts fail closed during preflight.
...
1. Enable the plugin on a reviewed exact Cubism host.
...
- **Status:** preview. The pipeline is admitted only on reviewed exact Cubism versions and eligible models, and it fails closed on every unadmitted input.
...
This is an official first-party plugin. See the project [EULA](https://github.com/turboism/Turboism/blob/main/EULA.md) and repository license for distribution terms.
