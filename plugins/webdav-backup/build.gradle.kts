    ...
    doLast {
        ...
        ZipFile(jarFile).use { archive ->
            check(archive.getEntry(
                ...
                "Backup plugin JAR is missing generated subscriber service metadata"
            }
            check(archive.getEntry(
                "dev/turboism/plugin/webdavbackup/BackupPlugin__TurboismSubscriberCatalog.class"
            ) != null) {
                "Backup plugin JAR is missing its generated subscriber catalog"
            }
        }
    }
}
