...
import dev.turboism.plugin.atlasmaxrectsbssf.layout.TextureAtlasPackingException;
...
public final class TextureAtlasAutoLayoutService {
    ...
    public TextureAtlasAutoLayoutService(
        final TextureAtlasLayoutService layouts,
        final dev.turboism.plugin.atlasmaxrectsbssf.layout.PartBucketTextureAtlasPlanner planner
    ) {
