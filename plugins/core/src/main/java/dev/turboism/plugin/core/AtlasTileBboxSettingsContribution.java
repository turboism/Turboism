...
/** Core-owned toggle for the atlas tile-bbox optimization, rendered in the shared Performance tab. */
final class AtlasTileBboxSettingsContribution {

    static final String CONTRIBUTION_ID = "atlas-tile-bbox";
    static final String LABEL_KEY = "settings.atlas.tile-bbox";

    private AtlasTileBboxSettingsContribution() {
    }

    /**
     * The toggle persists through {@link AtlasTileBboxSettingsService#save(boolean)} when the
    ...
    static SettingsContribution create(
        ...
        final AtlasTileBboxSettingsService settings
    ) {
